...
> Note: You'll need a Last.fm API key. Create a free account at [last.fm/api](https://www.last.fm/api) and add it to a `.env` file as `VITE_LASTFM_API_KEY=your_key_here`
